    ...
    <div>
      <ReactModal isOpen={isOpen} onRequestClose={handleModalClose}>
        <div className="w-10/12 mx-auto">
          ...
          <ul>
            <li className="list-disc ml-8">{projectDetails.bulletPoint[1]}</li>
            <li className="list-disc ml-8">{projectDetails.bulletPoint[2]}</li>
            <li className="list-disc ml-8">{projectDetails.bulletPoint[0]}</li>
          </ul>
          <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-12 my-4">
            ...
            />
            <div>
              <h4 className="font-bold text-lg text-center">Technology Used</h4>
